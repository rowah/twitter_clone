  ...
  return (
    <div class="bg-white sticky top-0 z-50">
      ...
      <div class=" flex text-base h-14">
        ...
        <div className="w-1/2 hover:bg-gray-200 pt-3">
          <span class="dark:hover:bg-gray-800 dark:hover:text-gray-200 ml-20 pb-4">
...
function Main() {
  return (
    <div class="w-1/2 border border-gray-200 h-auto  border-t-0">
      <MiddleNav />
    </div>
  );
}
