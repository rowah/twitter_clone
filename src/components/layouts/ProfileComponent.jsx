  ...
  return (
    <div>
      <div className="relative">
        ...
        />
        <img
          className="absolute z-20 bottom-3/5 left-4/5 transform -translate-y-1/2 rounded-full border-4 ml-5"
      ...
      <div className="flex justify-end">
        <button className="bg-gray-200 hover:bg-grey-400 font-semibold py-2 px-4 border border-black-500 hover:border-transparent text-black font-bold rounded-full mt-4 mr-3">
          Edit Profile
        </button>
      </div>
      ...
      <div className="mt-5 flex">
        <div>
          <span className="mx-2 text-lg font-bold flex flex-column">
            Jay Rowah
            <span>
              <a href="verified.co">
                <svg
      ...
      <div className="ml-3 mt-2 flex flex-wrap">
        <div className="flex mr-2">
          ...
          <span className="text-gray-500">Science &amp; Technology </span>
          <svg viewBox="0 0 24 24" aria-hidden="true" className="h-5 w-5">
            <g>
        ...
        <div className="flex mr-2">
          ...
          >
            ...
            <span className="text-blue-500">jrowah.com</span>
          </a>
        </div>

        <span className="flex text-gray-500 mr-2">
          <svg viewBox="0 0 24 24" aria-hidden="true" className="h-5 w-5">
            <g>
        ...
        >
          ...
          <span className="text-gray-500">Joined March 2009</span>
        </span>
      </div>
      <section className="flex ml-3 mt-2">
        <a href="ho.co" className="no-underline hover:underline">
          <span className="font-bold">10</span>
          <span> Following</span>
        </a>
        <a href="ho.co" className="ml-7 no-underline hover:underline">
...
function Timeline() {
  return (
    <div>
      <section>
        <div className="mt-3 ml-10 flex text-lg">
          <span className="mr-20 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 border-b-4 border-blue-500">
            <a href="twts.com">Tweets</a>
          </span>
          <span className="mr-20 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 border-b-indigo-500">
            <a href="twts.com">Replies</a>
          </span>
          <span className="mr-20 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
  ...
  return (
    <>
      <div className="flex sticky top-0 z-50 bg-white">
        <button
          type="button"
          className=" text-black rounded-l-md border-r border-gray-100 py-2 hover:bg-grey-700 hover:bg-grey px-3"
        >
        ...
        <div>
          <span className="font-bold">Jay Rowah</span>
          <br />
          <span className="text-gray-500">54.5K Tweets</span>
        </div>
      </div>
    </>
  );
