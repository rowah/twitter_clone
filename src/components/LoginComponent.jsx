      ...
      <div className="flex min-h-screen items-center justify-center">
        <div className="min-h-1/2 bg-white rounded-2xl ">
          <div className="mx-4 sm:mx-24 md:mx-34 lg:mx-56 mx-auto  flex items-center space-y-4 py-16 font-semibold text-gray-500 flex-col">
            ...
            <h1 className="text-black text-2xl">Sign in to Twitter</h1>
            <input
              onChange={(event) =>
                setCredentials({ ...credentials, email: event.target.value })
              }
              className="w-full p-2 bg-white rounded-md  border border-gray-700 focus:border-blue-300"
            ...
            <button
              onClick={login}
              className="w-full bg-blue-400 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full"
            >
              Button
            </button>
