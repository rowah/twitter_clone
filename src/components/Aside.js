function Aside() {
  return (
    <aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 sticky top-0 z-50">
      <a href="home.co">
        <img
          class="w-auto h-7"
        ...
        <nav class="-mx-3 space-y-6 ">
          <div class="space-y-3 ">
            ...
            >
              ...
              <span class="mx-4 font-medium">Twitter Blue</span>
            </a>
            ...
            >
              ...
              <span class="mx-4 font-medium">More</span>
            </a>
          </div>
          <div class="space-y-3 ">
