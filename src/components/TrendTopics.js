export default function TrendTopics() {
  return (
    <div class="ml-6 mt-6 p-3 bg-gray-200 rounded-lg sticky top-20 z-50">
      ...
      <div class="flex">
        <div class="flex-1">
          <p class="px-4 ml-2 mt-3 w-48 text-xs text-gray-600">1 . Trending</p>
          <h2 class="px-4 ml-2 w-48 font-bold text-black">#Kilimani</h2>
          <p class="px-4 ml-2 mb-3 w-48 text-xs text-gray-600">5,466 Tweets</p>
        </div>
        <div class="flex-1 px-4 py-2 m-2">
          <a
            href="/"
      ...
      <div class="flex">
        <div class="flex-1">
          ...
          <p class="px-4 ml-2 mb-3 w-48 text-xs text-gray-600">8,464 Tweets</p>
        </div>
        <div class="flex-1 px-4 py-2 m-2">
          <a
            href="/"
      ...
      <div class="flex">
        <div class="flex-1">
          ...
          <p class="px-4 ml-2 mb-3 w-48 text-xs text-gray-600">5,586 Tweets</p>
        </div>
        <div class="flex-1 px-4 py-2 m-2">
          <a
            href="/"
      ...
      <div class="flex">
        <div class="flex-1">
          ...
          <p class="px-4 ml-2 mb-3 w-48 text-xs text-gray-600">9,416 Tweets</p>
        </div>
        <div class="flex-1 px-4 py-2 m-2">
          <a
            href="/"
